...
<html lang="en">
 ...
 <form data-toggle="validator" role="form" method="post" class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-md-6">
        <input type="email" class="form-control" id="inputEmail" placeholder="Email" data-error="Incorrect email address" required>
